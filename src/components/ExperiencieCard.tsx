...
export default function ExperiencieCard () {
  return (
    <div className="bg-bluecard md:p-5 p-2 overflow-hidden rounded-2xl relative aspect-auto col-span-2 animate-fade-down animate-delay-[1700ms]">
      <Arrow />
      ...
      <img className='absolute top-0 left-0 opacity-30 pointer-events-none w-full h-full object-cover' width={572} height={278} src={coding} alt="gif of coding" />
    </div>
  )
}
