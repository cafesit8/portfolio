export default function Presentation() {
  return (
    <div className="bg-bluecard relative rounded-md col-span-3 aspect-square md:aspect-auto md:row-span-2 overflow-hidden">
          <div className='sm:p-7 p-4 w-full h-full flex'>
            <article className='self-start w-full h-full'>
              <h1 className="font-baloo400 text-left text-white md:mb-5 font-bold text-2xl md:text-[40px]">Hi, I'm Elias L. Melgarejo 👋</h1>
